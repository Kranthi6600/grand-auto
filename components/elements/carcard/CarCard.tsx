			...
			<div className="card-journey-small background-card hover-up">
					<div className="card-image">
						<Link href="/car-details">
							<img src={`/assets/imgs/cars-listing/cars-listing-6/${car.image}`} alt="Grand Auto" />
						</Link>
					</div>
					<div className="card-info p-4 pt-30">
						...
						<div className="card-title"><Link className="text-lg-bold neutral-1000 text-nowrap" href="/car-details">{car.name}</Link></div>
