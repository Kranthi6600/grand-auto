...
export default function CarsListingGrid() {
	return (
		<>
					...
					<div className="row pt-30">
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.2s">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/car-details">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-2.png" alt="Grand Auto" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.3s">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/car-details">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-3.png" alt="Grand Auto" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.4s">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/car-details">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-4.png" alt="Grand Auto" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
