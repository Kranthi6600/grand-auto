					...
					<div className="row">
						<div className="col-md-3 col-sm-12 footer-1">
							<div className="mt-20 mb-20">
								...
								<div className="box-info-contact mt-0">
									...
									<p className="text-md neutral-400 icon-email">support@grandauto.com</p>
								</div>
						...
						<div className="col-md-2 col-xs-6 footer-3">
							...
							<ul className="menu-footer">
								...
								<li><Link href="/term">Terms of Use</Link></li>
						...
						<div className="col-md-2 col-xs-6 footer-2">
							...
							<ul className="menu-footer">
								<li><Link href="/vehicles">Vehicle Listings</Link></li>
								<li><Link href="/car-details">Car Details</Link></li>
					...
					<div className="footer-bottom mt-50">
						<div className="row align-items-center justify-content-center">
							<div className="col-md-6 text-md-start text-center mb-20">
								<p className="text-sm color-white"> {new Date().getFullYear()} Grand Auto Inc. All rights reserved.</p>
							</div>
