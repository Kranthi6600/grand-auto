					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/page-header/banner1.png" alt="Grand Auto" />
							</div>
						...
						<div className="container">
							...
							<div className="row mt-50">
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-1.png" alt="Grand Auto" />
										</div>
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-2.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-3.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-4.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-5.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-6.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-7.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-8.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-9.png" alt="Grand Auto" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
											...
											<div className="swiper-wrapper">
													...
													<div className="card-testimonial background-card">
														...
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-1.png" alt="Grand Auto" /></div>
																<div className="card-info">
																	<p className="text-lg-bold neutral-1000">Sophia Moore</p>
																	<p className="text-md-regular neutral-1000">New York</p>
																</div>
															</div>
															<div className="card-rate"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Grand Auto" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Grand Auto" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Grand Auto" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Grand Auto" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Grand Auto" /></div>
														</div>
													</div>
												</SwiperSlide>
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														...
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-2.png" alt="Grand Auto" /></div>
																<div className="card-info">
												...
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														...
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-3.png" alt="Grand Auto" /></div>
																<div className="card-info">
									...
									<div className="col-lg-6">
										<div className="box-swiper">
											<Swiper {...swiperGroup1} className="swiper-container swiper-group-1">
												<div className="swiper-wrapper">
													<SwiperSlide className="swiper-slide">
														<img className="rounded-12" src="/assets/imgs/cta/cta-10/img-1.png" alt="Grand Auto" />
													</SwiperSlide>
													<SwiperSlide className="swiper-slide">
														<img className="rounded-12" src="/assets/imgs/cta/cta-10/img-1.png" alt="Grand Auto" />
													</SwiperSlide>
